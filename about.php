    ...
    <div class="col-md-4 mt-4 mt-md-0">
        <div class="card border-0 shadow mb-4">
            <div class="card-body">
                ...
                <div class="mt-3 text-center">
                    <a href="<?php echo SITE_URL; ?>dictionary.php" class="btn btn-dark">Browse Dictionary</a>
                </div>
            </div>
        </div>
        ...
        <div class="card border-0 shadow">
            <div class="card-body">
                ...
                <div class="mt-3">
                    <a href="<?php echo SITE_URL; ?>newsletters.php" class="btn btn-outline-dark">View Newsletters</a>
                </div>
            </div>
        </div>
    </div>
