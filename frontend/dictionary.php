...
<div class="alphabet-nav text-center mb-4">
    ...
    ?>        <a href="<?php echo $isAvailable ? FRONTEND_URL . 'dictionary.php?letter=' . $l : '#'; ?>" 
    ...
    ?>    <a href="<?php echo $isNumberAvailable ? FRONTEND_URL . 'dictionary.php?letter=%23' : '#'; ?>" 
                    ...
                    <div class="book-page">
                        ...
                        <ul class="term-list">
                            <?php foreach ($letterTerms as $term): ?>
                                <li class="term-item">
                                    <a href="<?php echo FRONTEND_URL . 'term.php?slug=' . htmlspecialchars($term['slug']); ?>" class="term-link">
