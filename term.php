...
<div class="row">
    <div class="col-12 mb-4">
        <a href="<?php echo SITE_URL; ?>dictionary.php" class="btn btn-outline-dark">
                        ...
                        <div class="related-terms mt-5">
                            ...
                            <div>
                                <?php foreach ($relatedTerms as $relatedTerm): ?>
                                    <a href="<?php echo SITE_URL . 'term.php?slug=' . htmlspecialchars($relatedTerm['slug']); ?>" class="term-link">
    ...
    <div class="col-md-4 mt-4 mt-md-0">
        <div class="card border-0 shadow mb-4">
            <div class="card-body">
                ...
                <div class="alphabet-nav">
                    ...
                    ?>
                        <a href="<?php echo $isAvailable ? SITE_URL . 'dictionary.php?letter=' . $letter : '#'; ?>" 
                    ...
                    <?php if (in_array('#', $availableLetters)): ?>
                        <a href="<?php echo SITE_URL; ?>dictionary.php?letter=%23" class="letter">#</a>
                    <?php else: ?>
        ...
        <div class="card border-0 shadow">
            <div class="card-body">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    ?>
                        <li class="list-group-item bg-transparent px-0">
                            <a href="<?php echo SITE_URL . 'term.php?slug=' . htmlspecialchars($randomTerm['slug']); ?>" class="text-decoration-none">
                ...
                <div class="mt-3">
                    <a href="<?php echo SITE_URL; ?>dictionary.php" class="btn btn-sm btn-dark">View All Terms</a>
                </div>
            </div>
        </div>
    </div>
